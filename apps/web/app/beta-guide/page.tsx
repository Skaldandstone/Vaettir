...
export default function BetaGuide() {
  return <main style={{ maxWidth: 760, margin: "40px auto", padding: 24 }}>
    ...
    <p>Pending membership invitations reserve seats. Revoke an unused invitation to make room. AI requests stop when credits are exhausted; ask your beta contact for help rather than creating another account.</p>
    ...
    <p>Ask that contact to pause your team, export data, or request deletion. There is no automatic deletion during the beta.</p>
