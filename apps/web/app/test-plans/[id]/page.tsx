...
export default function TestPlanDetailPage() {
  ...
  async function save() {
    ...
    setSaved(false);
    try {
      await trpc.testPlans.update.mutate({ id: params.id, name, description: description || undefined, status: status as never, customFields });
      setSaved(true);
      load();
    } catch (e) {
  ...
  async function updateCriterionStatus(id: string, description: string, requirementId: string | null, statusValue: string) {
    await trpc.testPlans.updateAcceptanceCriterion.mutate({ id, description, status: statusValue as never, requirementId });
    load();
  }

  async function removeCriterion(id: string) {
    await trpc.testPlans.deleteAcceptanceCriterion.mutate({ id });
    load();
  }
