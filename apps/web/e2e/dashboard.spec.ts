...
test.describe("Org dashboard", () => {
  test("the dashboard shows the org's readiness summary and the disposable project row", async ({ page }) => {
  ...
  test("clicking the disposable project row navigates to its project overview", async ({ page }) => {
    await page.goto("/dashboard");
