...
test.describe("AI reverse-engineering", () => {
  test("@ai pasting a real Jest test file produces at least one BDD test case", async ({ page }) => {
  ...
  test("@ai submitting as a background job returns a queued status instead of blocking", async ({ page }) => {
    await gotoFixtureReverseEngineer(page);
