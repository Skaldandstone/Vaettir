...
const local = {
  ...
  PLAYWRIGHT_BASE_URL: "http://localhost:3000", NEXT_PUBLIC_API_URL: "http://localhost:4000",
  CLERK_SECRET_KEY: "sk_test_placeholder", NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: "pk_test_placeholder",
};
